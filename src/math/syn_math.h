...
M3 m3i(float i);
M3 m3d(void);
M3 m3f(float f0, float f1, float f2, float f3, float f4, float f5, float f6, float f7, float f8);
M3 m3_m4(M4 matrix);
M4 m4i(float i);
M4 m4d(void);
M4 m4f(float f0, float f1, float f2, float f3, float f4, float f5, float f6, float f7, float f8, float f9, float f10, float f11, float f12, float f13, float f14, float f15);
